...
<head>
    ...
    <title>CryptoPay Admin Panel</title>
        ...
        <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/crypto.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                ...
                <div class="navbar-collapse">
                    ...
                    <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/bookingSystem/Admin.png" alt="user" class="profile-pic" /></a>
            ...
            <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">CryptoPay Admin</h4>
                            </div>
                     <div class="row">
