...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/1.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Pay through Crypto</h1>
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Delivery & CryptoPay</h4> </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Pay through Crypto</p>
                    </div>
                </div>
            </div>
        </section>
